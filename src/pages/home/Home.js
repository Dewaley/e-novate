      ...
      <section className="flex flex-col md:flex-row justify-center gap-x-8 items-center bg-primary gap-y-4 px-6 md:px-12 pt-4 pb-6 text-white">
        <div>
          ...
          <p className="opacity-60 pb-4 lg:max-w-[75%] font-light">
            ...
            emerging into this vast and diverse world of technology can be quite
            overwhelming and sometimes complicated. This is why at E-Novate
            Labs, we have deliberately put together a comprehensive step by step
            guide to make your journey into the IT world soft, smooth and easy.{" "}
          </p>
          <Link
            to="/courses"
