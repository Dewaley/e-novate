...
const NewsLetter = () => {
  ...
  return (
    <div className="bg-primary w-[90vw] rounded-lg flex items-center justify-center text-white flex-col md:flex-row gap-y-4 md:gap-y-0 md:gap-x-8 md:items-center md:justify-between mb-16 py-4 md:py-6 md:px-6 lg:w-[900px] p-2">
